...
@push('page-header', 'Data Kategori Campaign')
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Data Kategori Campaign</h4>
            </div>
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-lg-6">
                        <a href="{{ route('categories.create') }}" 
                            ...
                            data-toggle="tooltip" data-placement="top" title="Tambah Kategori Campaign">
